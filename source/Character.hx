...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'dracobot':
				frames = Paths.getSparrowAtlas('dracobot', 'shared', true);
			...
			case 'angyDracobot':
				frames = Paths.getSparrowAtlas('dracobot-angy', 'shared', true); //J: i now know why that scaling was so wack, so let me show you how that works
				animation.addByPrefix('idle', 'Dracobot Idle', 24, false); //J: VSC is being a cry baby, don't worry about it
				animation.addByPrefix('singUP', 'Dracobot Up', 24, false);
				animation.addByPrefix('singDOWN', 'Dracobot Down', 24, false);
				animation.addByPrefix('singLEFT', 'Dracobot Left', 24, false);
				animation.addByPrefix('singRIGHT', 'Dracobot Right', 24, false);
				
				animation.addByPrefix('singUP-alt', 'Dracobot Shutter', 24, false);
				animation.addByPrefix('singDOWN-alt', 'Dracobot Shutter', 24, false);
				animation.addByPrefix('singLEFT-alt', 'Dracobot Shutter', 24, false);
				animation.addByPrefix('singRIGHT-alt', 'Dracobot Shutter', 24, false);
			...
			case 'olevadon':
				frames = Paths.getSparrowAtlas('olevadon_assets', 'shared', true);
				animation.addByPrefix('idle', 'Idle', 24, false);
				animation.addByPrefix('singUP', 'Up', 24, false);
				animation.addByPrefix('singDOWN', 'Down', 24, false);
				animation.addByPrefix('singLEFT', 'Left', 24, false);
