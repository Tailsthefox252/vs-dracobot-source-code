...
class PlayState extends MusicBeatState
{
	...
	public static var iconP1:HealthIcon; // making these public again because i may be stupid
	public static var iconP2:HealthIcon; // what could go wrong?
	...
	public static var blackScreen:FlxSprite; // J: can't just blank out the screen lol
	...
	override public function create()
	{
		...
		switch (songLowercase)
		{
			...
			case 'senpai' | 'roses' | 'thorns' | 'power-on' | 'scan' | 'error-404' | 'solder':
	...
	{ // this actually handles press inputs
		if (PlayStateChangeables.botPlay || loadRep || paused)
			return; // first convert it from openfl to a flixel key code
